...
def main():
    ...
    print(f"Exporting {RERANKER_MODEL} to ONNX FP32...")
    model = CrossEncoder(RERANKER_MODEL, backend="onnx")
    model.save(FP32_DIR)
    print(f"Saved FP32 ONNX to {FP32_DIR}")
    ...
    print(f"Saved INT8 ONNX to {INT8_DIR}")

    print("Done. Reranker is ready for ONNX inference.")
